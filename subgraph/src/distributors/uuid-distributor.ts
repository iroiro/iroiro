...
import { UUIDCampaign as CampaignTemplate } from "../types/templates";
import {
  UUIDDistributor,
  CreateCampaign,
} from "../types/UUIDDistributor/UUIDDistributor";
import { UUIDCampaign } from "../types/templates/UUIDCampaign/UUIDCampaign";
...
export function handleCreateCampaign(event: CreateCampaign): void {
  ...
  let campaignContract = UUIDCampaign.bind(event.params.campaign);
