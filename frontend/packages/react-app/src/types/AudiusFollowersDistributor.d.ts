...
interface AudiusFollowersDistributorInterface extends ethers.utils.Interface {
  functions: {
...
export class AudiusFollowersDistributor extends Contract {
  ...
  interface: AudiusFollowersDistributorInterface;
